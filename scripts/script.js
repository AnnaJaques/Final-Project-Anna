/*
Student Name: Anna Jaques
File Name: script.js
*/

//Global variables
var answer = document.querySelector("#answer aside");
...
//Function to Display Incorrect Answer
function ansIncorrect() {
    heading.style.display = "block";
    answer.textContent = "That answer is not correct.";
...
function ansCorrect() {
    heading.style.display = "block";
    answer.textContent = "That answer is correct!";
}
